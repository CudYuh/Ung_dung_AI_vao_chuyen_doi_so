# Biển ban tổ chức, kích thước

## Thông tin định giá

- ID database: 16.0
- Tên hàng hóa: Biển ban tổ chức, kích thước
- Loại hàng hóa: Chưa xác định
- Đơn vị tính: cái
- Giá thẩm định: 10.000 VND
...
Biển ban tổ chức, kích thước: 25 x 16cm

## Vai trò trong LLM Wiki

Trang này là entity tri thức của vật tư **Biển ban tổ chức, kích thước**.
