...
- ID database: 920.0
- Tên hàng hóa: Xe vận chuyển thực phẩm 1 tầng
- Loại hàng hóa: Chưa xác định
- Đơn vị tính: Cái
- Giá thẩm định: 2.650.000 VND
...
-Kiểu xe 4 bánh, 2 bánh cố định và 2 bánh quay có phanh hãm.
- Kích thước sản phẩm: 600 x 800 x 850 mm
- Được cắt gấp bằng máy thủy lực. Các mối hàn được thực hiện bằng công nghệ hàn TIG, có khí argon bảo vệ mối hàn tránh hiện tượng ô xi hóa. Đảm bảo vệ sinh an toàn thực phẩm.

## Vai trò trong LLM Wiki

Trang này là entity tri thức của vật tư **Xe vận chuyển thực phẩm 1 tầng**.
