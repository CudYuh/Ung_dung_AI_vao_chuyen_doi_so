# Thảm trải sàn các hình vuông

## Thông tin định giá

- ID database: 1065.0
- Tên hàng hóa: Thảm trải sàn các hình vuông
- Loại hàng hóa: Chưa xác định
- Đơn vị tính: m2
- Giá thẩm định: 309.600 VND
...
Kích thước tấm : 60 x 60 cm, dày khoảng 1cm
Chất liệu : Xốp EVA + mặt thảm nỉ cao cấp độ bền cao

## Vai trò trong LLM Wiki

Trang này là entity tri thức của vật tư **Thảm trải sàn các hình vuông**.
