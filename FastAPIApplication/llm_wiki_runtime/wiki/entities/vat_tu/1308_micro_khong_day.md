...
- ID database: 1308.0
- Tên hàng hóa: Micro không dây
- Loại hàng hóa: Chưa xác định
- Đơn vị tính: Bộ (2 micro)
- Giá thẩm định: 4.675.000 VND
...
Micro
- Dải tần lựa chọn: 740MHz – 820MHz
- Dải tần số lựa chọn băng thông: 80MHz
- Chế độ điều chỉnh: FM
- Tần số đáp ứng: 50Hz ~ 18kHz
- Số lượng kênh điều chỉnh: 500/1000
- Độ nhạy đầu vào thực tế: >15dB
- Khoảng cách hoạt động ổn định: <100 mét
- THD: <0.5% (@1KHz)
- Tỷ số S / N> 80dB
- Công suất: ≦ 50mW
- Nguồn điện: DC 12-16V,  1200mA
- Màn hình: LCD + màn hình backlit nhiều màu

## Vai trò trong LLM Wiki

Trang này là entity tri thức của vật tư **Micro không dây**.
