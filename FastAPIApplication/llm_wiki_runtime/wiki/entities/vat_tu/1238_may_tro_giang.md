...
V-809
- Kích thước: 73x 48x118 mm.
 - Pin lithium 7.4V (1000mA).
 - Đáp ứng tần số 50Hz - 17Hz.
 - Chức năng: USB, thẻ nhớ, ghi âm.
 Sản phẩm sản xuất trên dây chuyền công nghệ được chứng nhận quản lý chất lượng theo tiêu chuẩn: ISO 9001:2015; ISO 14001:2015.

## Vai trò trong LLM Wiki

Trang này là entity tri thức của vật tư **Máy trợ giảng**.
