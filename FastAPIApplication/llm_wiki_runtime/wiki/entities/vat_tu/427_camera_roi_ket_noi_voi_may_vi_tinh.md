# Camera rời kết nối với máy vi tính

## Thông tin định giá

- ID database: 427.0
- Tên hàng hóa: Camera rời kết nối với máy vi tính
...
Tốc độ khung hình 30fps/s.
Góc quay 90 độ.
Có khả năng zoom được 4X.
Có thể mở rộng góc quay.
Kết nối: USB 2.0/3.0.
Tích hợp micro.
Tương thích hệ thống: Windows 7,8,10 / vista / xp / 2000 / Mac

## Vai trò trong LLM Wiki

Trang này là entity tri thức của vật tư **Camera rời kết nối với máy vi tính**.
