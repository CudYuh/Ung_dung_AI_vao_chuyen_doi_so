# Biển đại biểu, kích thước

## Thông tin định giá

- ID database: 17.0
- Tên hàng hóa: Biển đại biểu, kích thước
...
Biển đại biểu, kích thước: 25 x 16cm

## Vai trò trong LLM Wiki

Trang này là entity tri thức của vật tư **Biển đại biểu, kích thước**.
