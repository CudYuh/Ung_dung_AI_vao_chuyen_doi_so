# Maket phòng họp (khung + in, căng 2x1m)

## Thông tin định giá

- ID database: 190.0
- Tên hàng hóa: Maket phòng họp (khung + in, căng 2x1m)
- Loại hàng hóa: Chưa xác định
- Đơn vị tính: Cái
- Giá thẩm định: 730.000 VND
- Ngày thẩm định: 28/11/2025
- Chứng thư thẩm định: 405/2025/1143/CTTĐG-VNVIC
- Nguồn dữ liệu: …
...
Maket phòng họp (khung + in, căng 2x1m)
Khung Maket Kích Thước 1,2 X 2M
Khung Sát Hộp 16x16, Mặt Bạt Hiflex 0.32

## Vai trò trong LLM Wiki

Trang này là entity tri thức của vật tư **Maket phòng họp (khung + in, căng 2x1m)**.
