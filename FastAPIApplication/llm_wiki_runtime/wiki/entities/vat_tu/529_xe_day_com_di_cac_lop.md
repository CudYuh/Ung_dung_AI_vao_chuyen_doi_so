# Xe đẩy cơm đi các lớp

## Thông tin định giá

- ID database: 529.0
- Tên hàng hóa: Xe đẩy cơm đi các lớp
- Loại hàng hóa: Chưa xác định
- Đơn vị tính: bộ
- Giá thẩm định: 2.409.000 VND
...
-Kiểu xe 4 bánh, 2 bánh cố định và 2 bánh quay có phanh hãm. Bánh xe phi 100 mm
...
Trang này là entity tri thức của vật tư **Xe đẩy cơm đi các lớp**.
